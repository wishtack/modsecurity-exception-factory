...
# Hit Count: 656
SecRule SERVER_NAME "!@rx ^(1\.1\.1\.1|www\.shookalabs\.com)$" "id:10000,t:none,nolog,pass,skipAfter:EXCEPTION_1"
...
# Hit Count: 59
SecRule SERVER_NAME "!@rx ^(test\.domain\.com)$" "id:10007,t:none,nolog,pass,skipAfter:EXCEPTION_4"
