...
# Hit Count: 656
SecRule HOSTNAME "!@rx ^(1\\.1\\.1\\.1|www\\.shookalabs\\.com)$" "t:none,nolog,pass,skipAfter:1"
    # Hit Count: 651
...
# Hit Count: 8
SecRule REQUEST_FILENAME "!@rx ^(\\/agilefant\\/login\\.jsp)$" "t:none,nolog,pass,skipAfter:8"
    SecAction "t:none,nolog,pass,ctl:'ruleRemoveById=111111,222222'"
SecMarker 8
