...
# Hit Count: 656
SecRule HOSTNAME "!@rx ^(1\.1\.1\.1)$" "id:10000,t:none,nolog,pass,skipAfter:1"
    # Hit Count: 651
...
SecRule HOSTNAME "!@rx ^(test\.domain\.com)$" "id:10007,t:none,nolog,pass,skipAfter:4"
    ...
    # Hit Count: 1
    SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/static\/js\/backlogSelector\.js)$" "id:10015,t:none,nolog,pass,skipAfter:7"
        # Hit Count: 1
...
# Hit Count: 8
SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/login\.jsp)$" "id:10017,t:none,nolog,pass,skipAfter:8"
    # Hit Count: 8
...
# Hit Count: 55
SecRule HOSTNAME "!@rx ^(test\.domain\.com)$" "id:10000,t:none,nolog,pass,skipAfter:1"
    # Hit Count: 54
    SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/editIteration\.action|\/agilefant\/login\.jsp|\/agilefant\/static\/css\/main\.css|\/agilefant\/static\/img\/agilefant\-logo\-80px\.png|\/agilefant\/static\/img\/login\_gradient\.png|\/agilefant\/static\/img\/ui\/ui\-bg\_gloss\-wave\_55\_5c9ccc\_500x100\.png|\/agilefant\/static\/img\/ui\/ui\-bg\_inset\-hard\_100\_fcfdfd\_1x100\.png|\/agilefant\/static\/js\/backlogChooser\.js|\/agilefant\/static\/js\/backlogSelector\.js|\/agilefant\/static\/js\/date\.js|\/agilefant\/static\/js\/jquery\-ui\.min\.js|\/agilefant\/static\/js\/jquery\.cookie\.js|\/agilefant\/static\/js\/jquery\.dynatree\.js|\/agilefant\/static\/js\/jquery\.hotkeys\.js|\/agilefant\/static\/js\/jquery\.js|\/agilefant\/static\/js\/jquery\.wysiwyg\.js)$" "id:10001,t:none,nolog,pass,skipAfter:2"
        # Hit Count: 18
        SecAction "id:10002,t:none,nolog,pass,ctl:'ruleRemoveTargetById=960017;REQUEST_HEADERS:Host'"
        # Hit Count: 18
        SecAction "id:10003,t:none,nolog,pass,ctl:'ruleRemoveTargetById=981174;TX:anomaly_score'"
    ...
    # Hit Count: 1
    SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/static\/js\/backlogSelector\.js)$" "id:10005,t:none,nolog,pass,skipAfter:3"
        # Hit Count: 1
        SecAction "id:10006,t:none,nolog,pass,ctl:'ruleRemoveTargetById=981317;TX:sqli_select_statement_count'"
    SecMarker EXCEPTION_3
