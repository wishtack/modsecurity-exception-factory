...
SecRule HOSTNAME "!@rx ^(test\.domain\.com)$" "t:none,nolog,pass,skipAfter:4"
    ...
    # Hit Count: 4
    SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/login\.jsp)$" "t:none,nolog,pass,skipAfter:6"
        SecAction "t:none,nolog,pass,ctl:'ruleRemoveById=111111,222222'"
    SecMarker 6

    # Hit Count: 1
    SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/static\/js\/backlogSelector\.js)$" "t:none,nolog,pass,skipAfter:7"
        SecAction "t:none,nolog,pass,ctl:'ruleRemoveById=981317'"
    SecMarker 7
...
# Hit Count: 8
SecRule HOSTNAME "!@rx ^()$" "t:none,nolog,pass,skipAfter:8"
    # Hit Count: 8
    SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/login\.jsp)$" "t:none,nolog,pass,skipAfter:9"
        SecAction "t:none,nolog,pass,ctl:'ruleRemoveById=111111,222222'"
    SecMarker 9
...
# Hit Count: 55
SecRule HOSTNAME "!@rx ^(test\.domain\.com)$" "t:none,nolog,pass,skipAfter:1"
    # Hit Count: 54
    SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/editIteration\.action|\/agilefant\/login\.jsp|\/agilefant\/static\/css\/main\.css|\/agilefant\/static\/img\/agilefant\-logo\-80px\.png|\/agilefant\/static\/img\/login\_gradient\.png|\/agilefant\/static\/img\/ui\/ui\-bg\_gloss\-wave\_55\_5c9ccc\_500x100\.png|\/agilefant\/static\/img\/ui\/ui\-bg\_inset\-hard\_100\_fcfdfd\_1x100\.png|\/agilefant\/static\/js\/backlogChooser\.js|\/agilefant\/static\/js\/backlogSelector\.js|\/agilefant\/static\/js\/date\.js|\/agilefant\/static\/js\/jquery\-ui\.min\.js|\/agilefant\/static\/js\/jquery\.cookie\.js|\/agilefant\/static\/js\/jquery\.dynatree\.js|\/agilefant\/static\/js\/jquery\.hotkeys\.js|\/agilefant\/static\/js\/jquery\.js|\/agilefant\/static\/js\/jquery\.wysiwyg\.js)$" "t:none,nolog,pass,skipAfter:2"
        SecAction "t:none,nolog,pass,ctl:'ruleRemoveById=960017'"
        SecAction "t:none,nolog,pass,ctl:'ruleRemoveById=981174'"
        SecAction "t:none,nolog,pass,ctl:'ruleRemoveById=981203'"
    SecMarker 2
    ...
    # Hit Count: 1
    SecRule REQUEST_FILENAME "!@rx ^(\/agilefant\/static\/js\/backlogSelector\.js)$" "t:none,nolog,pass,skipAfter:3"
        SecAction "t:none,nolog,pass,ctl:'ruleRemoveById=981317'"
    SecMarker 3
